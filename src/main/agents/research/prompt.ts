...
JSON 顶层格式：
{"schemaVersion":1,"results":[{"taskKey":"输入任务 key","summary":"结论摘要","applicability":{"characterNames":[],"scenarioTags":[],"buildSignals":[]},"source":{"url":"https://...","title":"页面标题","timelineClue":"页面日期、版本或检索时可见的时间线索"},"conflicts":[]}]}
`.trim();
